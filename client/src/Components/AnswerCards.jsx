...
const AnswerCards = (props) => {
    ...
    useEffect(() => {
        ...
        Axios.get('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/getUser/' + props.user)
            .then(res => {
                setUsername(res.data.username);
                console.log(res.data);
                const serverURL = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/userimages';
