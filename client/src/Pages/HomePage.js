...
function HomePage() {
    ...
    const [axiosCall, setAxiosCall] = useState('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_all');
    ...
    const handleSearch = () => {
        if (searcher === '') {
            setAxiosCall('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_all');
        } else {
            setAxiosCall('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/searchquestion/' + searcher);
        }
    }
    ...
    const handleLoadMore = () => {
        ...
        if (newLoaded >= totalEntries) {
            setloadMoreS(false);
            setAxiosCall(`https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        } else {
            setAxiosCall(`https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        }
    }
