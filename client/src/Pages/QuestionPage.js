...
function QuestionPage() {
    ...
    const handleLike = async () => {
        ...
        try {
            Axios.get("https://open-dev-hosting-3b07672094d5.herokuapp.com/api/GetUserID/" + usermail)
                .then((res) => {
                    const response = res;
        ...
        // Get all likes
        Axios.get('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/like_get_all/')
            .then((res) => {
                ...
                if (bFound === false) {
                    ...
                    let url = "https://open-dev-hosting-3b07672094d5.herokuapp.com/api/like_add/";
                    let data = {
                        userID: USER,
                    ...
                    let url = "https://open-dev-hosting-3b07672094d5.herokuapp.com/api/like_delete/" + likeID;
                    ...
                    try {
                        ...
                        // Build the url and the data
                        let url = "https://open-dev-hosting-3b07672094d5.herokuapp.com/api/like_update/" + likeID;
                        let updata = {
                            userID: USER,
                            questionID: questionID,
                            type: "like"
    ...
    const handleDelete = async () => {
        let url = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_single/' + questionID;
        ...
        Axios.get(url).then(res => {
            ...
            if (sessionStorage.getItem("admin") === true || FoundUser === Id) {
                ...
                if (window.confirm('Are you sure you want to delete this question? This cannot be undone.') === true) {
                    // Build the url and the data
                    let url = "https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_delete/" + questionID;
    ...
    useEffect(() => {
        // Fetch the question
        Axios.get(`https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_single/${questionID}`)
            .then((result) => {
                ...
                Axios.get(`https://open-dev-hosting-3b07672094d5.herokuapp.com/api/getUser/${result.data.user}`)
                    .then((userResult) => {
                        setUsername(userResult.data.username);
                        const serverURLUser = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/userImages';
    ...
    const serverURL = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/images';
    ...
    const addAnswer = async () => {
        ...
        try {
            if (Id === null) {
                ...
                let urlGet = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question_get_single/' + questionID;
                ...
                let url = 'https://open-dev-hosting-3b07672094d5.herokuapp.com/api/question/' + questionID;
