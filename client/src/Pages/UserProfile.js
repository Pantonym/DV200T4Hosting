...
function Profile() {
    ...
    useEffect(() => {
        ...
        axios.get('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/userquestions/' + userID)
            .then((result) => {
        ...
        const fetchData = async () => {
            console.log('fetch');
            try {
                const userResponse = await axios.get('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/getUser/' + userID);
    ...
    const save = (e) => {
        ...
        axios.put('https://open-dev-hosting-3b07672094d5.herokuapp.com/api/updateuser/' + userID, updateUser)
            .then(() => {
